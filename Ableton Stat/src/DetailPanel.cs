...
namespace AbletonManager
{
    ...
    public sealed class DetailPanel : GlassControl
    {
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            _action.SetBounds(Pad, Height - Pad - h, Math.Max(Sc(40), Width - Pad * 2), h);
            ClampScroll();
        }

        /// <summary>
        /// Докуда можно рисовать содержимое. Место под кнопку резервируем всегда, чтобы
        /// список не прыгал, когда кнопка то есть, то нет.
        /// </summary>
        int BodyBottom { get { return Height - Pad - Sc(Theme.ControlH) - Sc(12); } }
