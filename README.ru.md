...
и проекты, где он звучит, — а звучит он сразу, как только выбран кликом или стрелкой, как в браузере
Live; `Space` останавливает. Любой сэмпл можно перетащить прямо в Live.
