...
**Фильтры** здесь — три режима: дерево папок, *Never used* — самые большие папки, из которых не взято
ни одного звука, тяжёлые первыми, — и *Most used*, рабочие звуки. У выбранного сэмпла видны волна, формат
и проекты, где он звучит. `Space` играет его — и дальше стрелки играют каждый сэмпл, на который встают,
как в браузере Live, пока `Space` не остановит. Любой сэмпл можно перетащить прямо в Live.
