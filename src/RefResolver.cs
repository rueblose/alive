...
namespace AbletonManager
{
    ...
    public static class RefResolver
    {
        ...
        // сетах сразу.
        //
        // Кешируем именно результат ПРОБЫ, а не саму ссылку: счётчики «всего файлов» и
        // «потеряно» по-прежнему считают каждое вхождение, поэтому числа в списке
        // остаются те же до единицы.
        //
