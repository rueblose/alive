...
namespace AbletonManager
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            // Прозрачность окон выключают в настройках, и узнать об этом надо ДО того,
            // как кто-нибудь тронет Theme: часть его цветов — static readonly и
            // вычисляются один раз, как раз по Glass.Enabled. Тронь Theme раньше — и
            // выключенное стекло получит цвета от включённого.
